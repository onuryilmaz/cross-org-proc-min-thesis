...
\item[Inductive Approach:] Methods proposed in this approach \cite{herbst1998integrating} \cite{herbst2000dealing} are based on finding the best Hidden Markov Models (HMMs) that represents the underlying process model. Workflow nets are constructed by using HMM nodes and inductive learning.
