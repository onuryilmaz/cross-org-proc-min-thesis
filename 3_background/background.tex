...
% Compared with IM, models discovered by IMi have a lower fitness, higher precision, equal generalisation and comparable simplicity.

Variants of \textit{Inductive Miner} are developed on ProM framework \cite{verbeek2010prom} and published as plugins by their authors. In this study, infrequent behavior capable implementation is used for experimenting the cross-organizational mining of process models.
