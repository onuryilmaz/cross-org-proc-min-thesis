...
\begin{enumerate}
	...
	\item $Assignments$ is a set of tuple $(Organization_{i}, Cluster_{j})$,
	\item $Cluster\ Centroids$ is a set of tuple $(Cluster_{j}, Centroids)$ where $Centroids$ is a union of tuples $(AvgTime_{A \rightarrow B}, Value)$ and $(StdTime_{A \rightarrow B}, Value)$.
\end{enumerate}
\end{definition}
