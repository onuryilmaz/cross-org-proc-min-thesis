...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{5_results_discussions/loan-application-process/ETM_Configuration1}
  \caption{Variant #1}
  \label{fig:loan-application-process-models-1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{5_results_discussions/loan-application-process/ETM_Configuration2}
  \caption{Variant #2}
  \label{fig:loan-application-process-models-2}
\end{subfigure} \\
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{5_results_discussions/loan-application-process/ETM_Configuration3}
  \caption{Variant #3}
  \label{fig:loan-application-process-models-3}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{5_results_discussions/loan-application-process/ETM_Configuration4}
  \caption{Variant #4}
...
In \textit{Performance Indicator Analysis} stage, firstly event logs are replayed over process models and performance indicators are calculated. For replaying step, alignment costs are presented with the process model mining evaluation metrics. 

%buraya da görsellik ekle
