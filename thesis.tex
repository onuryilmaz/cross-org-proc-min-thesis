...
\committeememberi[prof]{Ali Hikmet Doğru}
...
\committeememberiii[prof]{Nihan Kesim Çiçekli}
\affiliationiii{Computer Engineering Department, METU}
% Fourth committee member
\committeememberiv[prof]{İsmail Hakkı Toroslu}
